...
Proyecto de base de datos relacional para un ecommerce de cursos y talleres digitales.
...
Al ejecutar los scripts se crean las tablas del ecommerce, se cargan datos de prueba y se pueden consultar productos, ventas, clientes frecuentes, ticket promedio y transacciones de compra.
